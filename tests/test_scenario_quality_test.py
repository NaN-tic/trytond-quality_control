...
class Test(unittest.TestCase):
    ...
    def test(self):
        ...
        test.reload()
        self.assertEqual(test.qualitative_lines[0].success, False)
        ...
        test.save()
        self.assertEqual(test.qualitative_lines[0].success, True)
        self.assertEqual(test.quantitative_lines[0].success, True)
