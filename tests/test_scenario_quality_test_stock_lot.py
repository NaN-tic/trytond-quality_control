...
class Test(unittest.TestCase):
    ...
    def test(self):
        ...
        activate_modules(['stock_lot_deactivatable', 'quality_control'])
        ...
        allowed_doc, = IrModel.find([('name', '=', 'stock.lot')])
        ...
        self.assertEqual(tests_in.document, lot)
        ...
        self.assertEqual(test_out.document, lot)
